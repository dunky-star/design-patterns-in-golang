...
- Worker Pool pattern (`streamer/`: dispatcher, workers, MP4/HLS encoders; `internal/video`: job orchestration, lifecycle, secure media delivery and per-video-file metadata; Video Converter UI with MP4/HLS playback)
